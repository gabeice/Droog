...
var addMicListener = exports.addMicListener = function addMicListener(mic, ctx, ticker) {
  mic.addEventListener("click", function () {
    ...
    var switchSetting = switchContext(ctx, micState, ticker);
    ctx = switchSetting[0];
    ticker = switchSetting[1];
  });
};

var switchContext = function switchContext(ctx, micState, ticker) {
  ctx.close();
  clearInterval(ticker);
  var context = new AudioContext();
  var newTicker = (0, _wave_util.analyze)(context, micState);
...
var analyze = exports.analyze = function analyze(ctx, micState) {
  if (micState === "on") {
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  var ticker = (0, _wave_util.analyze)(ctx);

  var mic = document.getElementById("microphone");
  (0, _play_listeners.addMicListener)(mic, ctx, ticker);
});
