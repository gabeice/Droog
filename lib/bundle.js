...
var _wave_util = __webpack_require__(10);

var _metadata_util = __webpack_require__(9);
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  playButton.addEventListener("click", function () {
    ...
    setInterval(_wave_util.showFrequencyOsc, 100);
  });
  ...
  circles.forEach(function (circle) {
    return circle.addEventListener("click", function (e) {
      var color = toColor([e.offsetX, e.offsetY]);
    });
  });
});
...
var jDataView = __webpack_require__(5);
...
var showFrequencyOsc = exports.showFrequencyOsc = function showFrequencyOsc() {
  ...
  var tens = splitArray(frequencyData, 5).map(function (slice) {
    return Math.floor(average(slice));
  });

  d3.select("#test-bar").selectAll("div").data(tens).enter().append("div").style("height", function (d) {
    return d * 2 + "px";
  });
};
...
var showFrequencyMid = exports.showFrequencyMid = function showFrequencyMid() {
  ...
  d3.select("#test-bar").selectAll("div").data(tens).enter().append("div").style("margin-bottom", function (d) {
    return d[0] + "px";
