...
var jDataView = __webpack_require__(9);
...
var showFrequencyCircle = exports.showFrequencyCircle = function showFrequencyCircle(frequencyData) {
  var outerBar = document.getElementById("test-bar");
  outerBar.innerHTML = "";
...
var _wave_util = __webpack_require__(3);

var _metadata_util = __webpack_require__(2);

var _color_util = __webpack_require__(1);

var _type_selector = __webpack_require__(0);

document.addEventListener("DOMContentLoaded", function () {
  var playButton = document.querySelector(".fa-play");
  var pauseButton = document.querySelector(".fa-pause");
  var littleBar = document.querySelector(".little-bar");
  var audio = document.getElementById('audio');
