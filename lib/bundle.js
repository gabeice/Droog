...
var jDataView = __webpack_require__(8);
...
var showFrequencyOsc = exports.showFrequencyOsc = function showFrequencyOsc(frequencyData) {
  ...
  d3.select("#test-bar").selectAll("div").data(tens.slice(0, tens.length - 100)).enter().append("div").style("height", function (d) {
    return d * 2 + "px";
  });
};
...
var showFrequencyMid = exports.showFrequencyMid = function showFrequencyMid(frequencyData) {
  ...
  d3.select("#test-bar").selectAll("div").data(tens.slice(0, tens.length - 100)).enter().append("div").style("margin-bottom", function (d) {
    return d[0] + "px";
...
var showFrequencyCircle = exports.showFrequencyCircle = function showFrequencyCircle(frequencyData) {
  ...
  var littleBar = document.getElementById("little-bar");

  bar.style.height = Math.max.apply(Math, _toConsumableArray(frequencyData)) + "px";
  bar.style.width = Math.max.apply(Math, _toConsumableArray(frequencyData)) + "px";
...
var _wave_util = __webpack_require__(2);

var _metadata_util = __webpack_require__(1);

var _color_util = __webpack_require__(0);

var _type_selector = __webpack_require__(11);
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  var wave = document.getElementById("test-bar");

  (0, _type_selector.addTypeSelectors)(osc, cent, display, wave);

  var circles = document.querySelectorAll(".color-picker");
  circles.forEach(function (circle) {
    return circle.addEventListener("click", function (e) {
      var color = (0, _color_util.toColor)([e.offsetX, e.offsetY]);
      debugger;
    });
  });
});
...
var addTypeSelectors = exports.addTypeSelectors = function addTypeSelectors(osc, cent, display, wave) {
  ...
  conc.addEventListener("click", function (e) {
    ...
    var littleBar = document.createElement("section");
    littleBar.id = "little-bar";
    wave.appendChild(littleBar);

    wave.setAttribute("style", "justify-content: space-around; align-items: center; border-radius: 50%; background-color: turquoise; box-shadow: inset 0 0 3em white, 0 0 2em turquoise");
  });
};
